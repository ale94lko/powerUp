...
All code must meet the [Style Guide](https://powerUp.com/user_guide/general/styleguide.html), which is
...
powerUp recommends PHP 5.4 or newer to be used, but it should be
...
powerUp uses the [Git-Flow](http://nvie.com/posts/a-successful-git-branching-model/) branching model which requires all pull requests to be sent to the "develop" branch. This is
...
You must sign your work, certifying that you either wrote the work or otherwise have the right to pass it on to an open source project. git makes this trivial as you merely have to use `--signoff` on your commits to your powerUp fork.
...
`Signed-off-by: Alex Public <alex.public@example.com>`
...
Hard way The best way to contribute is to "clone" your fork of powerUp to your development area. That sounds like some jargon, but "forking" on GitHub means "making a copy of that repo to your account" and "cloning" means "copying that code to your environment so you can work on it".

1. [Set up Git](https://help.github.com/en/articles/set-up-git) (Windows, Mac & Linux)
2. Go to the [powerUp repo](https://github.com/ale94lko/powerUp)
3. [Fork it](https://help.github.com/en/articles/fork-a-repo)
4. [Clone](https://help.github.com/en/articles/fetching-a-remote#clone) your forked powerUp repo: git@github.com:<your-name>/powerUp.git.
...
Unlike systems like Subversion, Git can have multiple remotes. A remote is the name for a URL of a Git repository. By default your fork will have a remote named "origin" which points to your fork, but you can add another remote named "powerUp" which points to `git://github.com/bcit-ci/powerUp.git`. This is a read-only remote but you can pull from this develop branch to update your own.

If you are using command-line you can do the following:

1. `git remote add powerUp git://github.com/ale94lko/powerUp.git`
2. `git pull powerUp develop`
